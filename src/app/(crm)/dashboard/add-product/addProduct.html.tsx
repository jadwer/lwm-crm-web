                ...
                <div className="col-12 col-md-8">
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <input type="text" className="form-control" id="nombre del producto" placeholder="Nombre del producto"></input>
                        </div>
                        <div className="col-md-6">
                            <label className="form-label">Id del producto</label>
                            <input type="text" className="form-control" id="id del producto" placeholder="Id del producto"></input>
                        </div>
                        <div className="col-6">
                        ...
                        <div className="col-md-12">
                            <label className="form-label">Descripción corta del producto</label>
                            <input type="text" className="form-control" id="descripción corta del producto" placeholder="Descripción corta del producto"></input>
                        </div>
                    </div>
                </div>
